...
-- week, every Monday at 9:00 AM IST. The full flow is split across three
-- pieces:
--
...
--   3. `supabase/weekly-queue-setup.sql` — pg_cron job, Monday 03:30 UTC
--      (= 09:00 IST), that calls that function every Monday.
--
-- Guarantees:
